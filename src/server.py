...
class Server:
    ...
    def call(self, command, *args):
        ...
        dl = defer.DeferredList(
            [client.remote_game.callRemote(command, *args) for client in self.clients]
        )
    ...
    def start_game_if_ready(self):
        ...
        all_players_connected = False not in [
            player.connected for player in self.game.players
        ]
